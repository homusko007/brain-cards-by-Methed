...
const tableHeadCellMain = createElement('tr', {
    className: 'table__cell',
    textContent: 'main',
});

const tableHeadCellSecond = createElement('tr', {
    className: 'table__cell',
    textContent: 'second',
});

const tableHeadCellEmpty = createElement('tr', {
    className: 'table__cell',
});
...
const btnSave = createElement('button', {
    className: 'edit__btn edit__add-save',
    textContent: 'Сохранить',
});

const btnCancel = createElement('button', {
    className: 'edit__btn edit__add-cancel',
    textContent: 'Отмена',
});
